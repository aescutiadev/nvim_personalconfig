...
map("n", "<Leader>e", function()
  require("neo-tree.command").execute { toggle = true, position = "left", source = "filesystem", reveal = true }
end, { desc = "Open Float Neotree" })

map("n", "<Leader>bn", function()
  require("neo-tree.command").execute { toggle = true, position = "left", source = "buffers", reveal = true }
end, { desc = "Neotree buffers" })

map("n", "<Leader>bN", function()
  require("neo-tree.command").execute { toggle = true, position = "float", source = "buffers", reveal = true }
end, { desc = "Neotree buffers (float)" })
...
map("n", "<Leader><space>", function()
  require("neo-tree.command").execute { toggle = true, position = "float", source = "filesystem", reveal = true }
end, { desc = "Open Float Neotree" })
